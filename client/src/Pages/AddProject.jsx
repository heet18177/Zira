          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex items-center gap-2 mb-2 justify-between w-full flex-wrap">
              ...
              <button
                ...
                className="text-sm font-semibold text-white bg-[#0369A9] px-4 py-2 md:py-2.5 rounded-xl hover:bg-[#0ea5e9] transition-colors duration-300 cursor-pointer whitespace-nowrap"
              >
                View Projects
              </button>
            </div>
                ...
                <div>
                  ...
                  {form.projectMember.map((memberId) => {
                    ...
                    return (
                      <span
                        key={memberId}
                        className="inline-flex items-center mt-2 gap-2 px-3 py-1.5 rounded-lg bg-blue-50 border border-blue-100 text-sm font-medium text-[#0369A9]"
                      >
